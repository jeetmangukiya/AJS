...
if (isset($_REQUEST['psubmit'])) {
    ...
    if (($_REQUEST['pname'] == "") || ($_REQUEST['pdop'] == "") || ($_REQUEST['pava'] == "") || ($_REQUEST['ptotal'] == "") || ($_REQUEST['poriginalcost'] == "") || ($_REQUEST['psellingcost'] == "")) {
        ...
        $sql = "INSERT INTO products_tb (pname, pdop, pava, ptotal, poriginalcost, psellingcost) VALUES ('$pname', '$pdop','$pava', '$ptotal', '$poriginalcost', '$psellingcost')";
...
<div class="col-sm-6 mt-4  px-4 py-2" style="background-color: #F5F5F5; margin-bottom: 80px; margin-left:2px;">
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            <label for="poriginalcost">Original Cost for Each</label>
            <input type="text" class="form-control" id="poriginalcost" name="poriginalcost" onkeypress="isInputNumber(event)">
        </div>
        <div class="form-group">
            <label for="psellingcost">Selling Cost for each Each</label>
        ...
        <div class="text-center mt-3">
            ...
            <a href="products.php" class="btn btn-danger mx-2">Close</a>
        </div>
        <?php if (isset($msg)) {
            echo $msg;
        } ?>
