...
session_start();
 ...
 if(isset($_REQUEST['pupdate'])){
  ...
  $sql = "UPDATE products_tb SET pname = '$pname', pdop = '$pdop', pava = '$pava', ptotal = '$ptotal', poriginalcost = '$poriginalcost', psellingcost = '$psellingcost' WHERE pid = '$pid'";
...
<div class="col-sm-6 mt-4  px-4 py-2" style="background-color: #F5F5F5; margin-bottom: 80px; margin-left:2px;">
 ...
 if(isset($_REQUEST['view'])){
  $sql = "SELECT * FROM products_tb WHERE pid = {$_REQUEST['id']}";
